package et.press.ebook.ui.error;
...
import et.press.book.databinding.FragmentErrorBinding;
...
public class Error extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.emoji.setText(EpaConfig.SILLY_EMOJI[NumberUtils.getRandom(EpaConfig.SILLY_EMOJI.length)]);
