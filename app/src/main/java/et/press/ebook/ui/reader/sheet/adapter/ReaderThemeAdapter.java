package et.press.ebook.ui.reader.sheet.adapter;
...
import et.press.book.databinding.ItemReaderThemeBinding;
...
public class ReaderThemeAdapter extends RecyclerView.Adapter<ReaderThemeAdapter.MyViewHolder> {
    ...
    public ReaderThemeAdapter(OnReaderThemeSelected listener) {
        ...
        themes = new ArrayList<>(EpaConfig.themes.values());
        names = new ArrayList<>(EpaConfig.themes.keySet());
    }
