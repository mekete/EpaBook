...
import static et.press.ebook.util.NumberUtils.getRandom;
import static et.press.ebook.util.NumberUtils.toFloat;
import static et.press.ebook.util.NumberUtils.toInt;
...
public class NumberUtilsTest {
    ...
    public void toFloat_ShouldReturnValidFloat() {
        assertEquals(10F, toFloat("EpaChapter 10"), 0F);
        assertEquals(10.1F, toFloat("EpaChapter 10.1"), 0F);
